...
.. autoapisummary::
   ...
   perturbationx.read_dsv
   perturbationx.parse_pandas
   perturbationx.validate_nx_graph
   perturbationx.to_edge_list
   perturbationx.write_dsv
   perturbationx.format_dataset
   perturbationx.prune_network_dataset
   perturbationx.infer_graph_attributes
   perturbationx.generate_adjacencies
   perturbationx.generate_boundary_laplacian
   perturbationx.generate_core_laplacians
   perturbationx.permute_adjacency
   perturbationx.permute_edge_list
   perturbationx.coefficient_inference
   perturbationx.perturbation_amplitude
   perturbationx.perturbation_amplitude_contributions
   perturbationx.compute_variances
   perturbationx.confidence_interval
   perturbationx.test_permutations
   perturbationx.p_value
   perturbationx.toponpa.toponpa
   perturbationx.evaluate_modifications
   perturbationx.connect_adjacency_components
   perturbationx.get_neighborhood_components
   perturbationx.get_shortest_path_components
